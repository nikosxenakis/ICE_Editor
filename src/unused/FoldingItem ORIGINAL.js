...
function FoldingItem (element) {
    ...
    c.canvas.add(this.foldingItemBoxInCanvas);
    c.canvas.add(this.foldingItemInsideBoxHorizontialLineInCanvas);
    c.canvas.add(this.foldingItemInsideBoxVerticalLineInCanvas);
