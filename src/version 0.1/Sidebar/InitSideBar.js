               ...
               _.each(canvas.horizontalElements, function(elem) {
                    if (((elem.top > e.clientY + offsetTop &&
                          elem.top <= e.clientY + offsetTop + image.height) || (elem.top + elem.height > e.clientY + offsetTop
                            && elem.top + elem.height < e.clientY + offsetTop + image.height) || (elem.top < e.clientY + offsetTop &&
                ...
                if (canvas.elementsUnderDragElement.length > 1) {
                    ...
                    if (canvas.elementsUnderDragElement[0].isMinus === false || canvas.elementsUnderDragElement[1].id === "groupLogicExprError" || !(canvas.elementsUnderDragElement[1].top <= canvas.elementsUnderDragElement[0].top + canvas.elementsUnderDragElement[0].height + 4)) {
                        canvas.elementsUnderDragElement.length = 0;
